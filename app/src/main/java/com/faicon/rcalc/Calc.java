...
public class Calc extends Activity implements View.OnClickListener {
    ...
    public void operation() {
        if (optr.equals("+")) {
            op2 = Integer.parseInt(disp.getText().toString().replace("Resposta : ", ""));
            disp.setText("");
            if (op1 == 1 && op2 == 1) {
                disp.setText("Resposta : " + Integer.toString(1));
            }else{
                op1 = op1 + op2;
                disp.setText("Resposta : " + Integer.toString(op1));
            }
        } else if (optr.equals("-")) {
            op2 = Integer.parseInt(disp.getText().toString().replace("Resposta : ", ""));
            disp.setText("");
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            ...
            case R.id.cancel:
                ...
                op2 = 0;
                disp.setText("");
                disp.setHint("Aguardando Rache... ops Aguardando usuário)");
                break;
            case R.id.add:
                optr = "+";
                if (op1 == 0) {
